...
<div <?php echo self::get_element_attributes( self::sticky_element_props( $container_props, $fields_args ) ); ?>>
	...
	$fallback_image = (isset($fields_args['fallback_image'])) ? $fields_args['fallback_image'] : null;
    ...
    <?php } else { ?>
            ...
            <?php $link_after = '<a href="#" class="dropDown"><span class="dashicons dashicons-arrow-down-alt2"></span></i></a>';
            ...
            if ( $childpages ) { ?>
                ...
                <div class="picts_sub_page_list_wrapper"><ul class="picts_sub_page_list"><?php echo $childpages; ?></ul></div>
                
            <?php } elseif($parentpages && $parentpage_id !== 0) { ?>
                <div class="picts_sub_page_list_wrapper"><ul class="picts_sub_page_list"><?php echo $parentpages; ?></ul></div>
            <?php } else { ?>
