...
class Picts_Pictslinkblock_Module extends Themify_Builder_Component_Module
{
    ...
    {
        return __('Extended Link Block', 'themify');
    }
    ...
    public function get_options()
    {
        return array(
            ...
            array(
                ...
                'label' => 'icon',
                'binding' => array(
                    'empty' => array('hide' => 'icon_alignment'),
                    'not_empty' => array('show' => 'icon_alignment')
                ),
    ...
    {
?>
        <# const color=undefined===data.color || data.color=='default' ? 'tb_default_color' : data.color, tag=data.link?'a':'span'; #>
                ...
                <{{tag}} class="tb_link_block_container ui {{ color }}" <# if(data.link){#> href="{{data.link}}"<#}#> >
                    ...
                    <#if (data.icon_type!='image' && data.icon){ #>
                        <div class="tf-lb-icon">
                            <em class="tb_link_block_icon tf_inline_b">
                                <# print(api.Helper.getIcon(data.icon).outerHTML)#>
                            </em>
                        </div>
                        <# } else if ( data.icon_type=='image' && data.image ) { #>
